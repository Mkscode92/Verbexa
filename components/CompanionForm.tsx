...
import { z } from "zod" //validate inputs in our form 
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>What should the companion help with it?</FormLabel>
              <FormControl>
                <Textarea placeholder=" E.g. Triple Integrals" {...field} className='input'/>
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
